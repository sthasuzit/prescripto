  ...
  return (
    <div className='flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400'>
        ...
        <ul className='hidden md:flex items-start gap-5 font-medium'>
            ...
            <NavLink to='/doctors'>
                <li className='py-1'>ALL TECHNICIANS</li>
                <hr className='border-none outline-none h-0.5 bg-blue-800 w-3/5 m-auto hidden' />
            </NavLink>
            <NavLink to='/about'>
                ...
                ? <div className='flex items-center gap-2 cursor-pointer group relative'>
                    ...
                    <div className='absolute top-0 right-0 pt-14 text-base font-medium text-gray-600 hidden group-hover:block'>
                        <div className='min-w-48 bg-stone-100 rounded flex flex-col gap-4 p-4'>
                            ...
                            <p onClick={()=>{ auth.logoutUser(); navigate('/'); }} className='hover:text-black cursor-pointer'>Logout</p>
                        </div>
                    </div>
                </div>
                : <button onClick={()=>navigate('/login')} className='bg-blue-800 text-white px-8 py-3 rounded-full font-light hidden md:block'>Login</button>
            }
